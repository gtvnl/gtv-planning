...
RSpec.describe WeeksController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested week as @week" do
      week = Week.create! valid_attributes
      get :show, params: {id: week.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested week as @week" do
      week = Week.create! valid_attributes
      get :edit, params: {id: week.to_param}, session: valid_session
      expect(assigns(:week)).to eq(week)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Week" do
        expect {
          post :create, params: {week: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved week as @week" do
        post :create, params: {week: invalid_attributes}, session: valid_session
        expect(assigns(:week)).to be_a_new(Week)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested week" do
        week = Week.create! valid_attributes
        put :update, params: {id: week.to_param, week: new_attributes}, session: valid_session
        week.reload
      ...
      it "assigns the requested week as @week" do
        week = Week.create! valid_attributes
        put :update, params: {id: week.to_param, week: valid_attributes}, session: valid_session
        expect(assigns(:week)).to eq(week)
      end
    ...
    context "with invalid params" do
      it "assigns the week as @week" do
        week = Week.create! valid_attributes
        put :update, params: {id: week.to_param, week: invalid_attributes}, session: valid_session
        expect(assigns(:week)).to eq(week)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested week" do
      week = Week.create! valid_attributes
      expect {
        delete :destroy, params: {id: week.to_param}, session: valid_session
      }.to change(Week, :count).by(-1)
    end
